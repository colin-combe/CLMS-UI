...
function getMatchesCSV () {
	var csv = '"Id","Protein1","PepPos1","PepSeq1","LinkPos1","Protein2","PepPos2","PepSeq2","LinkPos2","Score","AutoVal","Val","Group"\r\n';
	...
	for (var i = 0; i < matchCount; i++){
		...
		if (result === true){
			csv += '"' + match.id + '","' + CLMSUI.utils.proteinConcat(match, "protein1")
				...
				+ match.score + '","' + match.autovalidated + '","' + match.validated + '","' + match.group + '"\r\n';
		}
	}
	return csv;
}
