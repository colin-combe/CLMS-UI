	...
	//<![CDATA[
			...
			ByRei_dynDiv.api.alter = function() {
				...
				if (ByRei_dynDiv.api.elem == 3){
					//~ var nglCanvas = d3.select("#nglDiv canvas");
					//var nglDiv = d3.select("#nglDiv");
					//~ var w = document.getElementById("nglDiv").clientWidth;
					//~ var h = document.getElementById("nglDiv").clientHeight;
					//~ console.log(w);
					//~ nglCanvas.attr("width", w).attr("height", h).style("width", w + "px").style("height", h + "px");//.attr("height",nglDiv.attr("clientHeight"));
					//~ //ng
			...
			*/
			...
			window.addEventListener("load", function() {
				...
				NGL.init( function(){
					...
					//~ stage.viewer.container.addEventListener(
						//~ 'resize', stage.viewer.onWindowResize.bind( stage.viewer ), false
					//~ );

					
					//~ var nglCanvas = d3.select("#nglDiv canvas");
					//~ nglCanvas.style("width", "100%").style("height", "100%");
