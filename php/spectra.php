...
'SELECT expmz, absoluteintesity as intensity, fragment_name, sequence, mass, charge, isprimarymatch, matchedpeptide  FROM v_spec_viewer_advanced_materialized WHERE spectrum_match_id = $1;') 
